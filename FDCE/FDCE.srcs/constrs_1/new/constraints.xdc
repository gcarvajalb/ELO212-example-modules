...
## CPU reset button
set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS33} [get_ports RST_BTN_n]
...
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {retain}]
## LEDs
...
## Color LEDs
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports led16[2]]; # R
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports led16[1]]; # G
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports led16[0]]; # B
#set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports led17[2]]; # R
#set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports led17[1]]; # G
#set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports led17[0]]; # B
