...
set rc [catch {
  ...
  write_bitstream -force -no_partial_bitfile nexys4_ddr.bit 
  catch { write_sysdef -hwdef nexys4_ddr.hwdef -bitfile nexys4_ddr.bit -meminfo nexys4_ddr.mmi -file nexys4_ddr.sysdef }
